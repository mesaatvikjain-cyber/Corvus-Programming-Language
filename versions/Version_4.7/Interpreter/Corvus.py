...
def main():
    ...
    if arg1 == "ai":
        ...
        elif subcmd in ("translate", "-t"):
            if len(sys.argv) < 4:
                print("Usage: corvus ai translate <file.py | code>")
            else:
                target = sys.argv[3]
                print(bot.translate(target))
        else:
            print(f"Unknown AI subcommand: {subcmd}")
            print("Available: corvus ai [chat | ask \"...\" | explain <file> | fix <file> | translate <file.py>]")
        return
    ...
    if arg1 in ("--repl", "-r"):
        ...
        print("Corvus Language Launcher & Toolchain v4.7.0")
        print("Usage:")
