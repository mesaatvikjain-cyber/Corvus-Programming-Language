...
CORVUS_DOCS = {
    ...
    "chan": "### `chan` (Concurrency Module)\nProvides thread-safe async channels (`chan.new()`).",
    "web": "### `web` (Networking Framework)\nProvides micro REST servers (`web.server()`) and real-time WebSockets (`web.ws_server()`).",
    "gamekit": "### `gamekit` (2D Game & Physics Engine)\nProvides `PhysicsWorld`, 2D bodies, collision detection, and audio effects.",
    "orm": "### `orm` (Database ORM)\nDeclarative SQLite active-record models (`cls User : orm.Model`).",
    "dataframe": "### `dataframe` (Data Engine)\nZero-dependency tabular data processing (`DataFrame.from_records()`, `read_csv()`)."
}
...
COMPLETIONS = [
    ...
    {"label": "chan.new", "kind": 3, "detail": "Create async channel", "insertText": "chan.new(${1:capacity})"},
    {"label": "web.server", "kind": 3, "detail": "Create REST web server", "insertText": "web.server(${1:8080})"},
    {"label": "web.ws_server", "kind": 3, "detail": "Create WebSocket server", "insertText": "web.ws_server(${1:8081})"},
    {"label": "gamekit.PhysicsWorld", "kind": 7, "detail": "2D Physics World", "insertText": "gamekit.PhysicsWorld(${1:0}, ${2:9.8})"},
    {"label": "orm.Model", "kind": 7, "detail": "Declarative SQLite ORM Model", "insertText": "cls ${1:User} : orm.Model [\n    set ${2:name}\n]"},
    {"label": "DataFrame", "kind": 7, "detail": "Reactive tabular DataFrame", "insertText": "DataFrame.from_records(${1:data})"},
