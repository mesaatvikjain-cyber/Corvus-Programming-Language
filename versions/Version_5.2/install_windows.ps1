# Corvus v4.6 Automated Windows Installer (Bytecode VM & .crvc Compiler)
Write-Host "================================================" -ForegroundColor Cyan
Write-Host "   Installing Corvus Programming Language v4.6  " -ForegroundColor Cyan
Write-Host "================================================" -ForegroundColor Cyan
...
Write-Host "`n[INSTALL COMPLETE] Corvus v4.6 installed!" -ForegroundColor Green
