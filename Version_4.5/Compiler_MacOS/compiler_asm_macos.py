    ...
    def generate(self, node):
        ...
        if node_type == "ProgramNode":
            ...
            if "    _input_buffer resq 1" not in self.bss_lines:
                self.bss_lines.append("    _input_buffer resq 1")
            ...
            self.text_lines.append("    lea rsi, [rel _input_buffer]")
            self.text_lines.append("    mov rax, 0")
            self.text_lines.append("    call _scanf")
            self.text_lines.append("    mov rax, [rel _input_buffer]")
