...
# One-click Windows installer for Corvus v5.2 Standalone Native Binaries

Write-Host "============================================================" -ForegroundColor Cyan
Write-Host "  Corvus v5.2 Standalone Native Binaries Installer (Windows)  " -ForegroundColor Cyan
Write-Host "============================================================" -ForegroundColor Cyan
...
Write-Host "`n[INSTALL COMPLETE] Corvus v5.2 Standalone Binaries Installed!" -ForegroundColor Green
...
Write-Host "  corvus tour" -ForegroundColor White
Write-Host "  corvus ai ask <question>" -ForegroundColor White
Write-Host "  corvus ai testgen <file.crv>" -ForegroundColor White
Write-Host "  corvus ai doc <file.crv>" -ForegroundColor White
Write-Host "  corvus ai review <file.crv>" -ForegroundColor White
Write-Host "  corvus ai export <file.crv> --target py|c" -ForegroundColor White
Write-Host "  corvus pkg init | add | install | list" -ForegroundColor White
Write-Host "  corvus lsp" -ForegroundColor White
Write-Host "  corvus compile <file.crv> --target wasm" -ForegroundColor White
