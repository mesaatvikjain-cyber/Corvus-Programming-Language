# Corvus Version 4.6 Standalone & Portable Distribution

Welcome to the official **Zero-Dependency Distribution Packages** for the **Corvus Programming Language (v4.6)**.

---

## 📦 Distribution Packages Overview

Corvus v4.6 introduces the **Corvus Bytecode Virtual Machine (CorvusVM)**, binary `.crvc` compilation, and disassembler alongside standalone zero-dependency packages:

### 🌟 Tier 1: Standalone Single-File Executables (`standalone/`)
* **`standalone/corvus.exe`** — The complete Corvus v4.6 engine:
...
* **`standalone/corvusc.exe`** — The complete Corvus v4.6 C99 Native Compiler driver with `-O3` pipeline optimization passes.
* **Key Benefits**:
...
## 🚀 Quick CLI Verification (v4.6 Features)
