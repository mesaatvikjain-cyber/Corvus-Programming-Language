...
def main():
    ...
    if arg1 == "ai":
        ...
        if subcmd in ("chat", "-c"):
            ...
            print("Available: corvus ai [chat | ask | explain | fix | translate | testgen | doc | review | export]")
        return
    ...
    if arg1 in ("--repl", "-r"):
        ...
        print("Corvus Language Launcher & Toolchain v5.0.0 (Enterprise Ecosystem)")
        print("Usage:")
