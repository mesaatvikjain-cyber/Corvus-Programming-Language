...
# One-click Windows installer for Corvus v5.0 Standalone Native Binaries

Write-Host "============================================================" -ForegroundColor Cyan
Write-Host "  Corvus v5.0 Standalone Native Binaries Installer (Windows)  " -ForegroundColor Cyan
Write-Host "============================================================" -ForegroundColor Cyan
...
Write-Host "`n[INSTALL COMPLETE] Corvus v5.0 Standalone Binaries Installed!" -ForegroundColor Green
