...
def main():
    ...
    if arg1 == "ai":
        ...
        if subcmd in ("chat", "-c"):
            ...
            print("Available: corvus ai [chat | ask | explain | fix | translate | testgen | doc | review | export | gen | refactor]")
        return
    ...
    if arg1 in ("--repl", "-r"):
        ...
        print("Corvus Language Launcher & Toolchain v5.1.0 (Omni-Platform Ecosystem)")
        print("Usage:")
