...
Write-Host "  [0] Standalone Native Binaries v4.7 (Zero Python Required) [RECOMMENDED]" -ForegroundColor Green
Write-Host "  [1] Version 4.7 (RavenAI Assistant, Transpiler & Hardened VM) [DEFAULT]"
Write-Host "  [2] Version 4.6 (Security Hardened, Bytecode VM & .crvc Compiler)"
Write-Host "  [3] Version 4.5 (Corvus Bytecode VM & .crvc Compiler)"
Write-Host "  [4] Version 4.4 (Universal Dual Syntax & Smart Type Inference)"
Write-Host "  [5] Version 4.3 (AI/ML Stack, 30+ StdLib Modules & Rust Diagnostics)"
Write-Host "  [6] Version 4.2 (Desktop 2D Graphics & Murder of Crows Concurrency)"
Write-Host "  [7] Version 4.1 (Super Optimizer Engine & Assembly Peephole)"
Write-Host "  [8] Version 4.0 (Native StdLib Expansion & REPL)"
Write-Host "  [9] Version 3.1 (Enterprise Error Resilience)"
Write-Host " [10] Version 3.0 (Self-Hosted Compiler & Concurrency)"
Write-Host " [11] Version 2.0 (Multi-Platform Native Assembly)"
Write-Host " [12] Version 1.1 (AST Visitor Interpreter)"

$choice = Read-Host "`nEnter selection (0-12) [Default: 1]"
